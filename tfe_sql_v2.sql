...
CREATE TABLE IF NOT EXISTS `toolsforever`.`locatie_has_products` (
  ...
  CONSTRAINT `voorraad`
    ...
    REFERENCES `toolsforever`.`products` (`voorraad`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `toolsforever`;
INSERT INTO `toolsforever`.`locatie_has_products` (`idlocatie`, `idproduct`, `voorraad`) VALUES (1, 1, 10);
INSERT INTO `toolsforever`.`locatie_has_products` (`idlocatie`, `idproduct`, `voorraad`) VALUES (1, 2, 15);
INSERT INTO `toolsforever`.`locatie_has_products` (`idlocatie`, `idproduct`, `voorraad`) VALUES (1, 3, 2);
INSERT INTO `toolsforever`.`locatie_has_products` (`idlocatie`, `idproduct`, `voorraad`) VALUES (2, 4, 4);
INSERT INTO `toolsforever`.`locatie_has_products` (`idlocatie`, `idproduct`, `voorraad`) VALUES (2, 5, 12);
INSERT INTO `toolsforever`.`locatie_has_products` (`idlocatie`, `idproduct`, `voorraad`) VALUES (2, 6, 54);
INSERT INTO `toolsforever`.`locatie_has_products` (`idlocatie`, `idproduct`, `voorraad`) VALUES (3, 7, 14);
INSERT INTO `toolsforever`.`locatie_has_products` (`idlocatie`, `idproduct`, `voorraad`) VALUES (3, 8, 11);
